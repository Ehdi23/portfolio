    ...
    <div class="skills-section__container">
      <div class="skills-section__content">
        <div class="skills-circle">
          <div class="skills-section__content__item">
            <svg
              width="60px"
              height="60px"
...
.skills-circle.start-animation .skills-section__content__item:nth-child(3) {
  transform: translate(-50%, -50%) rotate(180deg) translate(0, -120px);
}
.skills-circle.start-animation .skills-section__content__item:nth-child(4) {
  transform: translate(-50%, -50%) rotate(270deg) translate(0, -120px);
}

.skills-circle.rotate-animation {
...
@media screen and (min-width: 360px) and (max-width: 640px) {
  ...
  .skills-circle.start-animation .skills-section__content__item:nth-child(1) {
    transform: translate(-50%, -50%) rotate(0deg) translate(0, -90px);
  }
  .skills-circle.start-animation .skills-section__content__item:nth-child(2) {
    transform: translate(-50%, -50%) rotate(90deg) translate(0, -90px);
  }
  .skills-circle.start-animation .skills-section__content__item:nth-child(3) {
    transform: translate(-50%, -50%) rotate(180deg) translate(0, -90px);
  }
  .skills-circle.start-animation .skills-section__content__item:nth-child(4) {
